...
(function($)
{
    $.widget("awnry.pickList",
    {
        ...
        _buildSourceList: function()
        {
            ...
            self.sourceList.delegate(".pickList_listItem", "dblclick", {
                pickList: self
            }, function(e)
        ...
        _buildTargetList: function()
        {
            ...
            self.targetList.delegate(".pickList_listItem", "dblclick", {
                pickList: self
            }, function(e)
        ...
        _buildControls: function()
        {
            ...
            self.addAllButton = $("<button type='button'/>").click({
                pickList: self
            }, self._addAllHandler).html(self.options.addAllLabel).addClass(self.options.addAllClass);
            self.addButton = $("<button type='button'/>").click({
                pickList: self
            }, self._addHandler).html(self.options.addLabel).addClass(self.options.addClass);
            self.removeButton = $("<button type='button'/>").click({
                pickList: self
            }, self._removeHandler).html(self.options.removeLabel).addClass(self.options.removeClass);
            self.removeAllButton = $("<button type='button'/>").click({
                pickList: self
            }, self._removeAllHandler).html(self.options.removeAllLabel).addClass(self.options.removeAllClass);
        ...
        _removeItems: function(items)
        {
            ...
            self._trigger("afterRemove", null, {
                items: items
            });
            self._trigger("onChange", null, {
                type: "remove", 
        ...
        _addAllHandler: function(e)
        {
            ...
            self._trigger("afterAddAll", null, {
                items: items
            });
            self._trigger("onChange", null, {
                type: "addAll", 
        ...
        _removeAllHandler: function(e)
        {
            ...
            self._trigger("afterRemoveAll", null, {
                items: items
            });
            self._trigger("onChange", null, {
                type: "removeAll", 
