    ...
    <div class="grid_4">
        <div class="da-panel">
            ...
            <div class="da-panel-content">
                <div id="work_logcontrol">
                    <form id="searchwork_logcontrol"> 
                        <input id="id" name="id" type="hidden" value=""/> 
                    </form> 
                    <table id="tabel-work_logcontrol" style="display:none;">
                    </table>
                    <script type="text/javascript" >
                        ...
                        $('#sform').submit(function (){
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo site_url("work_log"); ?>',
                        ...
                        function datawork_logcontrol(com,grid){
                            ...
                            if (com=='Tambah Data'){
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '<?php echo site_url("hr/work_log/prepare_add"); ?>',
                                    data: dataString,
                                    cache: false,
                                    success: function(html){
                                        if(html!='')
                            ...
                            if (com=='Edit Data')
                            {
                                ...
                                else if(items.length > 1)
                                {
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo site_url("hr/work_log/prepare_edit"); ?>',
                                        data: dataString,
                                        cache: false,
                                        success: function(html){
                                            if(html!='')
                            ...
                            if (com=='Hapus Data')
                            {
                                ...
                                if (items.length == 0){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo site_url("hr/work_log/prepare_delete"); ?>',
                                        data: dataString,
                                        cache: false,
                                        success: function(html){
                                            if(html!='')
