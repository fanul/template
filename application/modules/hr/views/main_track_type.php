    ...
    <div class="grid_4">
        <div class="da-panel">
            ...
            <div class="da-panel-content">
                <div id="track_typecontrol">
                    <form id="searchtrack_typecontrol"> 
                        <input id="id" name="id" type="hidden" value=""/> 
                    </form> 
                    <table id="tabel-track_typecontrol" style="display:none;">
                    </table>
                    <script type="text/javascript" >
                        ...
                        $('#sform').submit(function (){
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo site_url("hr/track_type"); ?>',
                        ...
                        function datatrack_typecontrol(com,grid){
                            ...
                            if (com=='Ganti Status')
                            {
                                ...
                                if (items.length == 0){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo site_url("hr/track_type/prepare_status"); ?>',
                                        data: dataString,
                                        cache: false,
                                        success: function(html){
                                            if(html!='')
                            ...
                            if (com=='Tambah Data'){
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '<?php echo site_url("hr/track_type/prepare_add"); ?>',
                                    data: dataString,
                                    cache: false,
                                    success: function(html){
                                        if(html!='')
                            ...
                            if (com=='Edit Data')
                            {
                                ...
                                else if(items.length > 1)
                                {
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo site_url("hr/track_type/prepare_edit"); ?>',
                                        data: dataString,
                                        cache: false,
                                        success: function(html){
                                            if(html!='')
                            ...
                            if (com=='Hapus Data')
                            {
                                ...
                                if (items.length == 0){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo site_url("hr/track_type/prepare_delete"); ?>',
                                        data: dataString,
                                        cache: false,
                                        success: function(html){
                                            if(html!='')
                            ...
                            if (com=='Print')
                            {
                                ...
                                else if(items.length > 1)
                                {
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo site_url("hr/track_type/prepare_print"); ?>',
                                        data: dataString,
                                        cache: false,
                                        success: function(html){
                                            if(html!='')
