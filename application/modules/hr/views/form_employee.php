<div id="form_employeecontrol">
    ...
    <script type="text/javascript" >
        ...
        $(window).resize(function() {
            $('#form_employeecontrol').dialog("option", "position", ['center', 'center']);
        });
        
        $(document).ready(function () {
            
            $('#form_employeecontrol').dialog({
            ...
            //datepicker
            $('#box_employee_enter_date').datepicker({yearRange: "-30:+30",changeMonth: true,changeYear: true,dateFormat: "dd-mm-yy" <?php if (isset($hr_employee_enter_date)) { ?> , currentText: "<?php echo $hr_employee_enter_date; ?>" <?php } ?>});
            $('#box_employee_out_date').datepicker({yearRange: "-30:+30",changeMonth: true,changeYear: true,dateFormat: "dd-mm-yy" <?php if (isset($hr_employee_out_date)) { ?> , currentText: "<?php echo $hr_employee_out_date; ?>" <?php } ?>});
            $('#box_employee_birth_date').datepicker({yearRange: "-30:+30",changeMonth: true,changeYear: true,dateFormat: "dd-mm-yy" <?php if (isset($hr_employee_birth_date)) { ?> , currentText: "<?php echo $hr_employee_birth_date; ?>" <?php } ?>});

        });
	
        function femployeecontrol_send(){
            showLoading();
            ...
            $.ajax({
                ...
                success: function(html){
                    if (html == 'ok'){
                        hideLoading();
                        $('#form_employeecontrol').dialog('close');
                        showSukses('Proses berhasil');
                        $("#tabel-employeecontrol").flexReload();
                    }else{
        ...
        function displayPicture(pictureUrl){
            ...
            document.getElementById('box_employee_pict').value = pictureUrl;
        }
